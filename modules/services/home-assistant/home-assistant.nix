{ ... }: {
  ...
  flake.modules.nixos.home-assistant = { config, lib, ... }: {
    ...
    systemd.tmpfiles.rules = [
      "L+ ${config.services.home-assistant.configDir}/ui-lovelace.yaml - - - - ${
        ./dashboards/ui-lovelace.yaml
      }"
      "L+ ${config.services.home-assistant.configDir}/ui-h2d.yaml - - - - ${
        ./dashboards/ui-h2d.yaml
      }"
    ];
