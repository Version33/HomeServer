...
let
  ...
  # NOTE: JAR files are used but symlinked as .zip since Minecraft expects .zip extension for datapacks
...
in {
  ...
  systemd.tmpfiles.rules = [
    ...
    "L+ /var/lib/minecraft/world/datapacks/pickaxe-effective-reinforced-deepslate.zip - - - - ${pickaxeEffectiveReinforcedDeepslate}"
    "L+ /var/lib/minecraft/world/datapacks/silk-touch-budding-amethyst.zip - - - - ${silkTouchBuddingAmethyst}"
    "L+ /var/lib/minecraft/world/datapacks/pickaxe-effective-light-source-blocks.zip - - - - ${pickaxeEffectiveLightSourceBlocks}"
    "L+ /var/lib/minecraft/world/datapacks/pickaxe-effective-glass.zip - - - - ${pickaxeEffectiveGlass}"
    "L+ /var/lib/minecraft/world/datapacks/no-template-netherite-armor-upgrades.zip - - - - ${noTemplateNetheriteArmorUpgrades}"
    "L+ /var/lib/minecraft/world/datapacks/transparent-blocks-in-enchant-area.zip - - - - ${transparentBlocksInEnchantArea}"
    "L+ /var/lib/minecraft/world/datapacks/re-dye-terracotta.zip - - - - ${reDyeTerracotta}"
    "L+ /var/lib/minecraft/world/datapacks/re-dye-glass.zip - - - - ${reDyeGlass}"
    "L+ /var/lib/minecraft/world/datapacks/hoe-effective-froglights.zip - - - - ${hoeEffectiveFroglights}"
    "L+ /var/lib/minecraft/world/datapacks/hoe-effective-cactus.zip - - - - ${hoeEffectiveCactus}"
    "L+ /var/lib/minecraft/world/datapacks/smelt-raw-ore-blocks.zip - - - - ${smeltRawOreBlocks}"
    "L+ /var/lib/minecraft/world/datapacks/re-dye-concrete-powder.zip - - - - ${reDyeConcretePowder}"
    "L+ /var/lib/minecraft/world/datapacks/no-template-netherite-tool-upgrades.zip - - - - ${noTemplateNetheriteToolUpgrades}"
    "L+ /var/lib/minecraft/world/datapacks/breed-axolotl-with-tropical-fish-item.zip - - - - ${breedAxolotlWithTropicalFishItem}"
    "L+ /var/lib/minecraft/world/datapacks/iron-to-diamond-tools-upgrades.zip - - - - ${ironToDiamondToolsUpgrades}"
    "L+ /var/lib/minecraft/world/datapacks/iron-to-diamond-armor-upgrades.zip - - - - ${ironToDiamondArmorUpgrades}"
    "L+ /var/lib/minecraft/world/datapacks/more-dyed-wool-and-carpet.zip - - - - ${moreDyedWoolAndCarpet}"
    "L+ /var/lib/minecraft/world/datapacks/copper-block-beacon-base.zip - - - - ${copperBlockBeaconBase}"
    "L+ /var/lib/minecraft/world/datapacks/chiseled-bookshelves-add-enchantment-power.zip - - - - ${chiseledBookshelvesAddEnchantmentPower}"
    "L+ /var/lib/minecraft/world/datapacks/axe-effective-skulls.zip - - - - ${axeEffectiveSkulls}"
    "L+ /var/lib/minecraft/world/datapacks/blasting-smelts-glass.zip - - - - ${blastingSmeltsGlass}"
    "L+ /var/lib/minecraft/world/datapacks/silk-touch-reinforced-deepslate.zip - - - - ${silkTouchReinforcedDeepslate}"
    "L+ /var/lib/minecraft/world/datapacks/rebalanced-piglin-bartering.zip - - - - ${rebalancedPiglinBartering}"
    "L+ /var/lib/minecraft/world/datapacks/stone-to-iron-tools-upgrades.zip - - - - ${stoneToIronToolsUpgrades}"
    "L+ /var/lib/minecraft/world/datapacks/axolotls-ignore-passives.zip - - - - ${axolotlsIgnorePassives}"
    "L+ /var/lib/minecraft/world/datapacks/wooden-to-stone-tools-upgrades.zip - - - - ${woodenToStoneToolsUpgrades}"
    "L+ /var/lib/minecraft/world/datapacks/one-step-dyed-shulker-boxes.zip - - - - ${oneStepDyedShulkerBoxes}"
    "L+ /var/lib/minecraft/world/datapacks/infinity-mending-bows.zip - - - - ${infinityMendingBows}"
    "L+ /var/lib/minecraft/world/datapacks/amethyst-beacon-base.zip - - - - ${amethystBeaconBase}"
    "L+ /var/lib/minecraft/world/datapacks/redstone-beacon-base.zip - - - - ${redstoneBeaconBase}"
    "L+ /var/lib/minecraft/world/datapacks/lapis-beacon-base.zip - - - - ${lapisBeaconBase}"
    "L+ /var/lib/minecraft/world/datapacks/placeable-new-paintings.zip - - - - ${placeableNewPaintings}"
    "L+ /var/lib/minecraft/world/datapacks/infinity-on-crossbows.zip - - - - ${infinityOnCrossbows}"
    "L+ /var/lib/minecraft/world/datapacks/re-dye-concrete.zip - - - - ${reDyeConcrete}"
    "L+ /var/lib/minecraft/world/datapacks/re-dye-glazed-terracotta.zip - - - - ${reDyeGlazedTerracotta}"
    "L+ /var/lib/minecraft/world/datapacks/raw-copper-beacon-base.zip - - - - ${rawCopperBeaconBase}"
    "L+ /var/lib/minecraft/world/datapacks/raw-gold-beacon-base.zip - - - - ${rawGoldBeaconBase}"
    "L+ /var/lib/minecraft/world/datapacks/raw-iron-block-beacon-base.zip - - - - ${rawIronBlockBeaconBase}"
    "L+ /var/lib/minecraft/world/datapacks/looting-shears.zip - - - - ${lootingShears}"
    "L+ /var/lib/minecraft/world/datapacks/stonecutter-cuts-doors.zip - - - - ${stonecutterCutsDoors}"
    "L+ /var/lib/minecraft/world/datapacks/stonecutter-cuts-slabs.zip - - - - ${stonecutterCutsSlabs}"
    "L+ /var/lib/minecraft/world/datapacks/no-mending.zip - - - - ${noMending}"
    "L+ /var/lib/minecraft/world/datapacks/no-unbreaking-on-elytra.zip - - - - ${noUnbreakingOnElytra}"
  ];
}
